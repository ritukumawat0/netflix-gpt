...
const Login = () => {
  ...
  return (
    <div className="relative w-full h-screen">
      ...
      <div className="absolute top-96 sm:top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-1/3 max-lg:w-2/3 max-sm:w-full  p-12 bg-black/70 rounded-lg">
